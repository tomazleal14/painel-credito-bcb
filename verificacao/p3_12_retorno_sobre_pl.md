# Nota de verificação — P3 · Retorno sobre PL

`p3_12_retorno_sobre_pl`

| campo | conteúdo |
|---|---|
| Pergunta | **P3** |
| Fonte primária | IF.data · Resumo · Lucro Líquido ÷ Patrimônio Líquido |
| Campos de origem |  |
| Fórmula | `lucro_liquido_real ÷ patrimonio_liquido_real` |
| Referência de comparação | ATENÇÃO: o lucro do IF.data é acumulado no semestre (jan-mar, jan-jun, jul-set, jul-dez), então não é anualizado |
...
Observações válidas no último trimestre (202603): **1.349**.
