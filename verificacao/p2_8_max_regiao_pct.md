# Nota de verificação — P2 · Maior região
...
| Campos de origem |  |
| Fórmula | `fatia da região com maior participação na carteira` |
| Referência de comparação | leitura mais direta que o HHI regional, em % da carteira |
