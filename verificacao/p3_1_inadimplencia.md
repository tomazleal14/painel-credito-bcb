# Nota de verificação — P3 · Inadimplência
...
|---|---|
| Pergunta | **P3** |
| Fonte primária | IF.data · Carteira por carteiras de instrumentos financeiros · Inadimplência |
| Campos de origem |  |
| Fórmula | `carteira em atraso > 90 dias ÷ carteira de crédito` |
| Referência de comparação | regime ECL (Res. 4.966): disponível a partir de 2025Q1 |
