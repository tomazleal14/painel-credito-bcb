# Nota de verificação — P1 · Crescimento real da carteira
...
|---|---|
| Pergunta | **P1** |
| Fonte primária | IF.data · Resumo · Carteira de Crédito (deflacionada pelo IPCA/SGS 433) |
| Campos de origem |  |
| Fórmula | `carteira_real(t) / carteira_real(t-4) − 1` |
