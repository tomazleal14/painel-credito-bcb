# Nota de verificação — P1 · Crescimento do ticket médio

`p1_12_cresc_ticket_aa`

| campo | conteúdo |
|---|---|
| Pergunta | **P1** |
| Fonte primária | IF.data · Resumo ÷ Quantidade de clientes |
| Campos de origem |  |
| Fórmula | `(carteira_real/clientes)(t) ÷ (carteira_real/clientes)(t−4) − 1` |
| Referência de comparação | ticket subindo rápido = mais exposição por tomador |
...
Observações válidas no último trimestre (202603): **1.013**.
