# Nota de verificação — P3 · Ativos problemáticos ÷ PL

`p3_10_problematico_sobre_pl`

| campo | conteúdo |
|---|---|
| Pergunta | **P3** |
| Fonte primária | IF.data · Ativos problemáticos ÷ Resumo · Patrimônio Líquido |
| Campos de origem |  |
| Fórmula | `ativos problemáticos ÷ patrimônio líquido` |
| Referência de comparação | capacidade de absorver a perda com capital próprio |
...
Observações válidas no último trimestre (202603): **1.079**.
