# Nota de verificação — P2 · Ticket médio por cliente
...
|---|---|
| Pergunta | **P2** |
| Fonte primária | IF.data · Resumo ÷ Quantidade de clientes com operações ativas |
| Campos de origem |  |
| Fórmula | `carteira_real ÷ nº de clientes ativos` |
| Referência de comparação | proxy de granularidade; NÃO mede exposição aos maiores devedores |
...
Observações válidas no último trimestre (202603): **1.063**.
