# Nota de verificação — P3 · Variação da inadimplência
...
|---|---|
| Pergunta | **P3** |
| Fonte primária | derivado de p3_1_inadimplencia |
| Campos de origem |  |
| Fórmula | `inadimplência(t) − inadimplência(t−4), em p.p.` |
| Referência de comparação | nível alto e estável difere de nível que está subindo |
...
Observações válidas no último trimestre (202603): **1.008**.
