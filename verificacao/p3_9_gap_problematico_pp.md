# Nota de verificação — P3 · Distância problemático − inadimplência

`p3_9_gap_problematico_pp`

| campo | conteúdo |
|---|---|
| Pergunta | **P3** |
| Fonte primária | IF.data · Ativos problemáticos e Inadimplência |
| Campos de origem |  |
| Fórmula | `(ativos problemáticos − atraso 90+) ÷ carteira` |
| Referência de comparação | mede o que foi renegociado ou reestruturado sem virar atraso |
