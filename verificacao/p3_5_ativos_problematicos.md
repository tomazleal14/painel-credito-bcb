# Nota de verificação — P3 · Ativos problemáticos
...
|---|---|
| Pergunta | **P3** |
| Fonte primária | IF.data · Carteira por instrumentos financeiros · Ativos problemáticos |
| Campos de origem |  |
| Fórmula | `ativos problemáticos (Res. 4.557) ÷ carteira de crédito` |
