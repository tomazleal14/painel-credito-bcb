# Nota de verificação — P3 · Ativos problemáticos sobre a carteira
...
| Campos de origem | `ativos_problematicos_valor`, `carteira_credito` |
| Fórmula | `ativos problemáticos / carteira` |
| Referência de comparação | SCR.data — ativo problemático do sistema |
