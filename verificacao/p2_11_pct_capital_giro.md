# Nota de verificação — P2 · Carteira PJ em capital de giro

`p2_11_pct_capital_giro`

| campo | conteúdo |
|---|---|
| Pergunta | **P2** |
| Fonte primária | IF.data · Carteira PJ por modalidade |
| Campos de origem |  |
| Fórmula | `capital de giro ÷ total da carteira PJ` |
...
Observações válidas no último trimestre (202603): **762**.
